...
const Disclosures = () => {
  return (
    <section 
      className="relative mx-auto py-8 sm:py-12 md:py-16 lg:py-10 bg-white px-4 sm:px-6 md:px-8 lg:px-0"
      style={{ 
        color: "#606060", 
    ...
    >
      ...
      {/*State Licenses and Notices */}
      <div className="mb-6 sm:mb-8">
        <button className="text-[13px] sm:text-[14.4px] font-normal hover:underline transition-all">
          View state licenses and notices.
        </button>
      </div>

      {/* New Jersey & New Mexico Residents */}
      <div className="flex flex-col gap-3 sm:gap-4 mb-6 sm:mb-8 ml-0 sm:ml-[30px] md:ml-[60px]">
        <p className="text-[13px] sm:text-[14px] md:text-[14.5px] font-medium leading-[18.8px] sm:leading-[20.8px]">
          New Jersey residents: This is an advertisement for a consumer loan.
        </p>
        <p className="text-[13px] sm:text-[14px] md:text-[14.6px] font-medium leading-[18.8px] sm:leading-[20.8px]">
      ...
      {/*  NMLS Section */}
      <div className="flex flex-wrap items-center gap-1 mb-6 sm:mb-8 text-[13px] sm:text-[14.4px] font-medium ml-0 sm:ml-[30px] md:ml-[60px]">
        <span>NMLS #1671904. View the</span>
        <button className="font-normal hover:underline transition-all">NMLS Consumer Access Database</button>
      </div>
      ...
      {/*  Lender Information */}
      <div className="mb-6 sm:mb-8">
        <h3 className="text-[13px] sm:text-[14px] md:text-[14.8px] font-medium mb-2 uppercase tracking-wide">
          Personal loans information
        </h3>
        <p className="text-[13px] sm:text-[14px] md:text-[14.6px] font-medium leading-[18.8px] sm:leading-[20.8px] ml-0 sm:ml-[30px] md:ml-[60px]">
          Lender information: Personal loans in NM and WI are originated by Oportun Inc. Personal loans in AL, AK, AR, AZ, CA, DE, FL, GA, HI, ID, IL, IN, KS, KY, LA, MI, MN, MO, MS, MT, NC, ND, NE, NH, NJ, NV, OH, OK, OR, PA, RI, SC, SD, TN, TX, UT, VA, VT, and WY are originated by Pathward <sup className="text-[8px] sm:text-[10px]">®</sup>, N.A. THIS IS A LOAN SOLICITATION ONLY. OPORTUN MAY NOT BE THE LENDER. INFORMATION RECEIVED WILL BE SHARED WITH PATHWARD IN CONNECTION WITH YOUR LOAN INQUIRY. THE LENDER MAY NOT BE SUBJECT TO ALL VERMONT OR OTHER STATE LENDING LAWS. THE LENDER MAY BE SUBJECT TO FEDERAL LENDING LAWS.
        </p>
      </div>

      {/* Product Terms */}
      <div className="flex flex-col gap-4 sm:gap-6 mb-6 sm:mb-8 ml-0 sm:ml-[30px] md:ml-[60px]">
        <div>
          <p className="text-[13px] sm:text-[14px] md:text-[14.5px] font-medium leading-[18.8px] sm:leading-[20.8px]">
      ...
      <div className="flex flex-col gap-4 sm:gap-6 mb-6 sm:mb-8">
        ...
        <p className="text-[13px] sm:text-[14px] md:text-[14.6px] font-medium leading-[18.8px] sm:leading-[20.8px] px-0 sm:px-[30px] md:px-[60px]">
      ...
      {/*Trust & Stats */}
      <div className="flex flex-col gap-2 mb-6 sm:mb-8 text-[12px] sm:text-[13px] md:text-[14.6px] font-medium leading-[18px] sm:leading-[20.8px] px-0 sm:px-[30px] md:px-[60px]">
      ...
      {/* Copyright Line */}
      <div className=" border-gray-200 pt-6 mt-[-20px] sm:pt-8">
        <p className="text-[12px] sm:text-[13px] md:text-[14.5px] font-medium font-inter text-center sm:text-left">
