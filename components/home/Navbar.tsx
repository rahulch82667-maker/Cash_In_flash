...
const Navbar = () => {
  const [activeDropdown, setActiveDropdown] = useState<"loans" | "save" | null>(
    null,
  );
  ...
  const { user, loading, initialCheckComplete } = useAppSelector(
    (state) => state.auth,
  );
  ...
  const DesktopDropdownContent = ({ type }: { type: "loans" | "save" }) => {
    ...
    return (
      ...
      >
        ...
        <div
          className={`flex flex-col absolute ${isLoans ? "left-[581px]" : "left-[409px]"} top-[50px]`}
        >
          <div className="w-[201px] flex flex-col gap-[18px]">
            ...
            <p className="text-[#FAFAFA] font-medium text-[14px] leading-[19.2px] font-['Poppins']">
              Get Fast Cash Today: Secure Payday Loans with Instant Approval and
              Same-Day Deposits. Apply Online in Minutes!
            </p>
          </div>
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-[9999] flex flex-col items-center bg-white shadow-sm md:shadow-none">
          ...
          <div className="flex items-center gap-4 lg:gap-[71px]">
            <Link href="/">
              <div className="shrink-0">
                <Image
                  ...
                  width={220}
                  height={30}
                  className="lg:w-[250px] lg:h-[32px]"
                  priority
                />
              </div>
            </Link>
            ...
            <div className="flex items-center gap-2 lg:gap-[30px] h-[83px]">
              ...
              >
                ...
                <span className="font-['Poppins'] font-medium text-[15px] lg:text-[16px] text-[#353535] z-10">
                  Loans
                </span>
              </div>
          ...
          <div className="flex items-center gap-4 lg:gap-[35px]">
            <Link href="/location-finder">
              <div className="hidden lg:flex items-center gap-[8px] cursor-pointer group">
                <MapPin className="w-[24px] h-[24px] text-[#353535] group-hover:text-[#15C15D] transition-colors" />
                <span className="font-['Poppins'] font-medium text-[16px] group-hover:text-[#15C15D] transition-colors">
                  Find a Store
                </span>
              </div>
            </Link>
        ...
        <div className="md:hidden fixed top-[112px] left-0 w-full h-[calc(100vh-112px)] bg-[#0C1D17] z-50 flex flex-col p-6 animate-in slide-in-from-right duration-300 overflow-y-auto">
          <div className="flex flex-col gap-6 text-white pb-10">
              ...
              {mobileLoansOpen && (
                <div className="flex flex-col gap-[17px] mt-[17px] pl-[14px]">
                  <h3
                    ...
                    className="text-[#13EC6D] font-bold text-[16px] uppercase leading-none tracking-wider"
                  >
                    LOANS
                  </h3>
            ...
            <div className="flex flex-col gap-[17px] mt-[17px] pl-[14px]">
              <h3
                style={poppinsMenuHeader}
                className="text-[#13EC6D] font-bold text-[16px] uppercase leading-none"
              >
                TOOLS
              </h3>
            ...
            <div className="flex flex-col gap-[17px] mt-[17px] pl-[14px]">
              ...
              <div className="w-[201px] flex flex-col gap-[18px]">
                ...
                <p
                  style={poppinsMoneyText}
                  className="text-[#FAFAFA] font-medium text-[14px] leading-[19.2px] font-['Poppins']"
                >
            ...
            <Link href="/location-finder" className="block w-fit" onClick={() => setIsMobileMenuOpen(false)}>
              <div className="flex items-center gap-2 py-3 mt-4 cursor-pointer group">
                <MapPin
                  ...
                  size={24}
                />
                <span className="font-['Poppins'] font-medium text-[16px] text-white group-hover:underline">
                  Find a Store
                </span>
              </div>
            </Link>
